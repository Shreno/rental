        ...
        <div id="pagee" class="clearfix">
            ...
            <header id="header" class="main-header home3 header header-fixed style-absolute  ">
                            ...
                            <div class="col-lg-12">         
                                <div class="inner-container flex justify-space align-center">
                                    ...
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="index.html"><img src="{{ asset('assets/images/logo/logo2.png') }}" alt="" title=""></a></div>
                                    </div>
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo"><a href="index.html"><img src="{{ asset('assets/images/logo/logo@2x.png') }}" alt="" width="197" height="48"></a></div>
            ...
            <!-- End Main Header -->
                ...
                <section class="slider home2 home3">
                    <div class="slider-item">
                        <div class="img-slider">
                            <img class="img-item" src="{{ $banner ? asset($banner->image) : asset('images/bg-slider.jpg') }}" alt="">
                        </div>
                ...
                <section class="flat-your" style="margin-top:100px">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box hv-one2 ">
                                                <div class="images img-style2">
                                                    <a href="properties-map-v1.html" class="icon-plus"><img src="{{ asset($city->image) }}" alt="images"></a>
                                                    <img class="img br-10" src="{{ asset($city->image) }}" alt="images">
                                                </div>
                                                <div class="content link-style-3">
                                                    <a href="properties-map-v1.html" class=""><h3>{{ $city->name }}</h3></a>
                                                    <p class="text-color-1">{{ $city->properties->count() }} listing</p>
                                                ...
                                                <div class="box box-dream hv-one">
                                                    <div class="image-group relative ">
                                                        <div class="swiper-container noo carousel-2 img-style"  >    
                                                            <a href="property-detail-v1.html" class="icon-plus"><img src="{{ asset('assets/images/icon/plus.svg') }}" alt="images"></a>
                                                            <div class="swiper-wrapper ">
                                                                <div class="swiper-slide"><img src="{{ asset($property->images->first()->image) }}" alt="{{ $property->title }}"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <h3 class="link-style-1"><a href="property-detail-v1.html">{{ $property->title }}</a> </h3>
                ...
                <section class="flat-search-home " style="background: url({{ asset('images/bg-search-home.jpg') }})">
                ...
                <section class="flat-contact2" style="">
                    <div class="container">
                        <div class="row">                      
                            <div class="col-lg-12">
                                ...
                                <div class="mark-img" style="top:0">
                                    <img src="{{ asset('images/find-for-your-dream-home.jpg') }}" style="width: 300px;height: 300px;"  alt="images">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="group-icon group-2">
                                <div class="box-icons flex">
                                    <div class="images">
                                        <img src="{{ asset('assets/images/icon/footer-icon-2.png') }}" alt="images">
                                    </div>
                                    <div class="content">
                                        <div class="title-icon fs-30 lh-45 fw-7 text-color-2">Rent your house</div>
                                        <p class="font-2 text-color-2">We will connect you to thousands of people who need to Rent a home.</p>
                                    </div>
                                </div>
                                ...
                                <div class="box-icon flex align-center justify-space">
                                    <div class="img-group flex align-center">
                                        <div class="images flex-none">
                                            <img src="{{ asset('assets/images/author/author-footer.jpg') }}" alt="images">
                                        </div>
                                        <div class="content">
                                            <p>Darrell Steward</p>
                        ...
                        <div class="col-lg-12">
                            <div class="wrap-logo flex align-center justify-space">
                                <div class="logo-footer style box-1" id="logo-footer">
                                    <a href="index.html">
                                        <img src="{{ asset('assets/images/logo/logo-footer@2x.png') }}" alt="img" width="197" height="48">
                                    </a>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body space-y-20 pd-40">
                    <div class="wrap-modal flex">
                        <div class="images flex-none">
                            <img src="{{ asset('assets/images/section/bg-login.jpg') }}" alt="images">
                            <div class="mark-logo">
                                <img src="{{ asset('assets/images/logo/logo2.png') }}" alt="images">
                            </div>
                        </div>
                        <div class="content">
                                ...
                                <div class="respond-comment">
                                    <form method="post" class="comment-form form-submit" action="#" accept-charset="utf-8">
                                        <fieldset class="">
                                            ...
                                            <img class="img-icon img-email" src="{{ asset('assets/images/icon/icon-gmail.svg') }}" alt="images">
                                        </fieldset>   
                ...
                <div class="modal-body space-y-20 pd-40 style2">
                    <div class="wrap-modal flex">
                        <div class="images flex-none relative">
                            <img src="{{ asset('assets/images/section/bg-register.jpg') }}" alt="images">
                            <div class="mark-logo">
                                <img src="{{ asset('assets/images/logo/logo2.png') }}" alt="images">
                            </div>
                        </div>
                                ...
                                <div class="respond-comment">
                                    <form method="post" class="comment-form form-submit" action="#" accept-charset="utf-8"  novalidate="novalidate" >
                                        ...
                                        <fieldset class="">
                                            ...
                                            <img class="img-icon img-name" src="{{ asset('assets/images/icon/login-user.svg') }}" alt="images">
                                        </fieldset>   
                                        <fieldset class="t">
                                            <label class="fw-6">Email</label>
                                            <input type="email"  class="tb-my-input" name="email" placeholder="Email" >
                                            <img class="img-icon" src="{{ asset('assets/images/icon/icon-gmail.svg') }}" alt="images">
                                        </fieldset> 
                                        <fieldset class="">
                                            <label class="fw-6">Password</label>
                                            <input type="password" class="input-form password-input" placeholder="Your password" >
