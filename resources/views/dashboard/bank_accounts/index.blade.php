...
@section('pageTitle' , __('dashboard.bank_accounts'))
        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Add customer-->
                    <a href="{{ route('bank-accounts.create')}}" class="btn btn-primary">@lang('dashboard.create_title', ['page_title' => __('dashboard.bank_account')])</a>
                    <!--end::Add customer-->
                    <span class="w-5px h-2px"></span>
                    <button type="button" data-route="{{route('bank-accounts.deleteAll')}}" 
