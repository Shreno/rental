                            ...
                            <tr data-id="{{$client->id}}">
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route('admins.destroy', $client->id)}}" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-url="{{route('admins.destroy', $client->id)}}" data-id="{{$client->id}}">@lang('dashboard.delete')</a>
                                        </div>
                                        @endcan 
                                        <!--end::Menu item-->
                                    </div>
