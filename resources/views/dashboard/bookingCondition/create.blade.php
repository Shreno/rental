                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                    ...
                                    style="background-image: url({{ isset($bookingCondition) && $bookingCondition->icon ? asset($bookingCondition->icon) : asset('dashboard/assets/media/svg/files/blank-image.svg') }})">
