...
<div class="left-menu">
    ...
    <div id="sidebar-menu">
        ...
        <div class="logo-box d-flex">
            <div class="logo">
                <a href="index.html">
                    <img src="{{asset('client/assets/images/logo/logo3@2x.png')}}" alt="" width="197" height="48" class="img-logo">
                    <img src="{{asset('client/assets/images/logo/toggle-logo@2x.png')}}" alt="" width="46" height="48" class="toggle-logo">
                </a>
            </div>
        </div>
        ...
        <ul class="downmenu list-unstyled" id="side-menu">
            ...
            <li>
                <a href="{{route('client-properties.create')}}" class="tf-effect">
            ...
            <li>
                ...
                <span class="dash-titles">المفضل لدى</span>
                </a>
            </li>
            <li>
                <a href="#" class="tf-effect">
                ...
                <span class="dash-titles">البحث</span>
                </a>
            </li>
            <li>
                <a href="#" class="tf-effect">
                ...
                <span class="dash-titles">حزمتي</span>
                </a>
            </li>
            <li>
                <a href="#" class="tf-effect">
                    ...
                    <span class="dash-titles">تغيير الرقم السرى</span>
                </a>
            </li>
            <li>
                ...
                <span class="dash-titles">تسجيل الخروج</span>
                </a>
            </li>
        </ul>
    </div>
