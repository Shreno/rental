                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="slogan-logo">
                                            <a href="#">
                                                <img src="{{asset('website/assets/images/img-box/brand-1.png')}}" alt="images">
                                            </a>
                                        </div>                         
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slogan-logo">
                                            <a href="#">
                                                <img src="{{asset('website/assets/images/img-box/brand-2.png')}} alt="images">
                                            </a>
                                        </div>                         
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slogan-logo">
                                            <a href="#">
                                                <img src="{{asset('website/assets/images/img-box/brand-3.png')}} alt="images">
                                            </a>
                                        </div>                         
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slogan-logo">
                                            <a href="#">
                                                <img src="{{asset('website/assets/images/img-box/brand-4.png')}} alt="images">
                                            </a>
                                        </div>                         
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slogan-logo">
                                            <a href="#">
                                                <img src="{{asset('website/assets/images/img-box/brand-5.png')}} alt="images">
                                            </a>
                                        </div>                         
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slogan-logo">
                                            <a href="#">
                                                <img src="{{asset('website/assets/images/img-box/brand-6.png')}} alt="images">
                                            </a>
                                        </div>                         
                                    </div>
                                </div>
                    ...
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2>خصائص مميزة</h2>
                                <p class="text-color-4">اكتشف التميز في كل زاوية من زوايا عقاراتنا! </p>
                            </div>
                            <div class="flat-tabs themesflat-tabs">
                                <div class="box-tab center">
                                    <ul class="menu-tab tab-title flex justify-center">
                                        ...
                                        <li class="item-title active hv-tool" data-tooltip="{{count($propertyFeature->property)}} {{__('website.property')}}">
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container carousel-2 img-style" >    
                                                        ...
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="icon-box flex">
                                                        ...
                                                        <div class="icons icon-3 flex"><span>قدم :</span><span class="fw-6">1150</span></div>
                                                    </div>   
                                                    <div class="days-box flex justify-space align-center">
                                                        <a class="compare flex align-center fw-6" href="#">مقارنة</a>
                                                        <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="{{asset('website/assets/images/author/author-6.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-42.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style"  >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-43.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-2.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-35.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-36.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-37.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-6.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                                        </div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">   
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-38.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-7.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                                        </div>
                                    ...
                                    <div class="content-inner tab-content">
                                        <div class="wrap-item flex">
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-31.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-2.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-32.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style"  >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-33.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-2.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative">
                                                    <span class="featured fs-12 fw-6">مميز</span>  
                                                    <span class="featured style fs-12 fw-6">مميز</span>    
                                                    <span class="icon-bookmark"><i class="far fa-bookmark"></i></span> 
                                                    <div class="swiper-container  carousel-2 img-style"  >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-34.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-2.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-26.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-1.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-17.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-6.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">   
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-28.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-27.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-23.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-24.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-25.jpg')}}" alt="images"></div>
                                                        </div>
                                                        <div class="pagi2"><div class="swiper-pagination2" >  </div> </div>
                                                        <div class="swiper-button-next2 "><i class="fal fa-arrow-right"></i></div>
                                                        <div class="swiper-button-prev2 "><i class="fal fa-arrow-left"></i> </div>                                        
                                            ...
                                            <div class="box box-dream hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="swiper-container  carousel-2 img-style" >    
                                                        ...
                                                        <div class="swiper-wrapper ">
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-25.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-11.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                            <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-8.jpg')}}" alt="images"></div>
                                                        </div>
            ...
            <section class="flat-search-area wg-search-area">
                <div class="container-full">
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2>ابحث عن العقارات حسب المنطقة</h2>
                                <p class="text-color-4">ابحث عن شقة أحلامك مع قائمتنا</p>
                            </div>
                            <div class="wrap-search-area flex">
                                <div class="box">
                                    <div class="images">
                                       <img class="imgs" src="{{asset('website/assets/images/img-box/search-area-1.jpg')}}" alt="images">
                                       <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="box">
                                    <div class="images">
                                        <img class="imgs" src="{{asset('website/assets/images/img-box/search-area-2.jpg')}}" alt="images">
                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-3"><a href="property-detail.html">كاليفورنيا</a></h3>
                                ...
                                <div class="box">
                                    <div class="images">
                                        <img class="imgs" src="{{asset('website/assets/images/img-box/search-area-3.jpg')}}" alt="images">
                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-3"><a href="property-detail.html">كاليفورنيا</a></h3>
                                ...
                                <div class="box">
                                    <div class="images">
                                        <img class="imgs" src="{{asset('website/assets/images/img-box/search-area-4.jpg')}}" alt="images">
                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-3"><a href="property-detail.html">كاليفورنيا</a></h3>
                                ...
                                <div class="box">
                                    <div class="images">
                                        <img class="imgs" src="{{asset('website/assets/images/img-box/search-area-5.jpg')}}" alt="images">
                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-3"><a href="property-detail.html">كاليفورنيا</a></h3>
                                ...
                                <div class="box">
                                    <div class="images">
                                        <img class="imgs" src="{{asset('website/assets/images/img-box/search-area-6.jpg')}}" alt="images">
                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-3"><a href="property-detail.html">كاليفورنيا</a></h3>
                                ...
                                <div class="box">
                                    <div class="images">
                                        <img class="imgs" src="{{asset('website/assets/images/img-box/search-area-7.jpg')}}" alt="images">
                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-3"><a href="property-detail.html">كاليفورنيا</a></h3>
                                ...
                                <div class="box">
                                    <div class="images">
                                        <img class="imgs" src="{{asset('website/assets/images/img-box/search-area-8.jpg')}}" alt="images">
                                        <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                    </div>
                                    <div class="content">
                                        <h3 class="link-style-3"><a href="property-detail.html">كاليفورنيا</a></h3>
                                ...
                                <div class="one-carousel owl-carousel owl-theme">
                                    ...
                                    <div class="slide-item">
                                        <div class="box box-dream hv-one">
                                            <div class="image-group relative ">
                                                <span class="featured fs-12 fw-6">مميز</span>   
                                                <span class="featured style fs-12 fw-6">للبيع</span>      
                                                <span class="icon-bookmark"><i class="far fa-bookmark"></i></span> 
                                                <div class="swiper-container carousel-2 img-style">    
                                                    <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                    <div class="swiper-wrapper ">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <a class="compare flex align-center fw-6" href="#">مقارنة</a>
                                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="{{asset('website/assets/images/author/author-12.jpg')}}" alt="images"></div>
                                                    <div class="days">منذ 3 سنوات</div>
                                                </div>                                           
                                            </div>
                                        </div>
                    ...
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                ...
                                <p class="text-color-8">عقارات للإيجار بمواقع مميزة</p>
                            </div>
                            <div class="swiper-container2"  >    
                                        ...
                                        <div class="box box-dream hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="swiper-container carousel-2 img-style" >    
                                                    <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                    <div class="swiper-wrapper ">
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-12.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-22.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-23.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-24.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-25.jpg')}}" alt="images"></div>
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <a class="compare flex align-center fw-6" href="#">مقارنة</a>
                                                    <div class="img-author hv-tool" data-tooltip="Kathryn Murphy"><img src="{{asset('website/assets/images/author/author-13.jpg')}}" alt="images"></div>
                                                    <div class="days">منذ 3 سنوات</div>
                                                </div>                                           
                                            </div>
                                        </div>
                                        ...
                                        <div class="box box-dream hv-one">
                                            <div class="image-group relative">
                                                ...
                                                <div class="swiper-container  carousel-2 img-style" >    
                                                    <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                    <div class="swiper-wrapper ">
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-13.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-2.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                        ...
                                        <div class="box box-dream hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="swiper-container  carousel-2 img-style">    
                                                    <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                    <div class="swiper-wrapper ">
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-14.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-7.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-8.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-9.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-10.jpg')}}" alt="images"></div>
                                                    </div>
                                                    <div class="pagi2"><div class="swiper-pagination2" >  </div> </div>
                                                    <div class="swiper-button-next2 "><i class="fal fa-arrow-right"></i></div>
                                                    <div class="swiper-button-prev2 "><i class="fal fa-arrow-left"></i> </div>                                        
                                        ...
                                        <div class="box box-dream hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="swiper-container  carousel-2 img-style" >    
                                                    <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                    <div class="swiper-wrapper ">
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-15.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-2.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-3.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-4.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-5.jpg')}}" alt="images"></div>
                                        ...
                                        <div class="box box-dream hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="swiper-container  carousel-2 img-style" >    
                                                    <a href="property-detail.html" class="icon-plus"><img src="{{asset('website/assets/images/icon/plus.svg')}}" alt="images"></a>
                                                    <div class="swiper-wrapper ">
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-16.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-22.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-23.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-24.jpg')}}" alt="images"></div>
                                                        <div class="swiper-slide"><img src="{{asset('website/assets/images/house/featured-25.jpg')}}" alt="images"></div>
                ...
                <div class="container">
                    <div class="row">                      
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="#"><img src="{{asset('website/assets/images/img-box/meet-1.jpg')}}" alt="images"></a>
                                ...
                                <div class="content flex justify-space">
                                    <div class="inner">
                                        <h3 class="link-style-1"><a href="#">دانييل إيفان</a></h3>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="#"><img src="{{asset('website/assets/images/img-box/meet-2.jpg')}}" alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                                        <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="content flex justify-space">
                                    <div class="inner">
                                        <h3 class="link-style-1"><a href="#">كايدن كارتر</a></h3>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images relative img-style">
                                    <a href="#"><img src="{{asset('website/assets/images/img-box/meet-3.jpg')}}" alt="images"></a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#"><i class="fab fa-twitter"></i></a>
                                        <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                ...
                                <div class="content flex justify-space">
                                    <div class="inner">
                                        <h3 class="link-style-1"><a href="#">دارلين روبرتسون</a></h3>
                        ...
                        <div class="col-lg-12">
                            <div class="box-text flex justify-center">
                                <p>كن وكيلًا واحصل على العمولة التي تستحقها. </p> <a href="contact.html" class="text-color-3 font-2 fw-7"> اتصل بنا</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">                      
                        <div class="col-lg-6">
                            <div class="heading-section">
                                <h2 class="font-2 fw-8">نحن نقدم لك العقارات الأكثر ملاءمة و جودة.</h2>
                                <p class="text-color-4">نحن نقدم لك العقارات التي تجمع بين الجودة العالية والملاءمة المثلى لتلبية احتياجاتك.</p>
                            </div>
                            <div class="wrap-info">
                                <div class="box-info flex align-center">
                                    ...
                                    <div class="content">
                                        ...
                                        <h4 class="fw-4">2715 Ash Dr. سان خوسيه، داكوتا الجنوبية 83475</h4>
                                    </div>
                                </div>
                                <div class="box-info flex align-center">
                                    <div class="icon-info">
                                    ...
                                    <div class="content">
                                        <h5 class="text-color-4">طلب إعادة الاتصال</h5>
                                ...
                                <div class="box-info flex align-center">
                                    ...
                                    <div class="content">
                                        <h5 class="text-color-4">راسلنا عبر البريد الإلكتروني</h5>
                                        <a href="mailto:hellosupport@gmail.com"><h4 class="fw-4 text-color-3">hellosupport@gmail.com</h4></a>
                                    </div>
                                </div>
                            </div>
                            <div class="mark-contact animate-up">
                                <img class="img-icon" src="{{asset('website/assets/images/mark/transformed.png')}} alt="images">
                            </div>
                        </div>
                        <div class="col-lg-6">
                                    ...
                                    <div class="respond-comment">
                                        <form method="post" id="contactform" class="comment-form form-submit"
                                            ...
                                            <fieldset class="name-wrap">
                                                <label class="font-2 fw-8 fs-16">الاسم</label>
                                                <input type="text" class="tb-my-input" name="name" placeholder="الاسم" required="">
                                                <img class="img-icon" src="{{asset('website/assets/images/icon/contact-name.svg')}}" alt="images">
                                            </fieldset>
                                            <div class="text-wrap flex">
                                                <fieldset class="email-wrap style-text">
                                                    <label class="font-2 fw-8 fs-16">الايميل</label>
                                                    <input type="email" class="tb-my-input" name="email" placeholder="الايميل" required="">
                                                        <img class="img-icon img-email" src="{{asset('website/assets/images/icon/contact-email.svg')}}" alt="images">
                                                </fieldset>
                                                <fieldset class="phone-wrap style-text">
                                                    <label class="font-2 fw-8 fs-16">الهاتف</label>
                                                    <input type="tel" class="tb-my-input" name="tel" placeholder="الهاتف" required="">
                                                    <img class="img-icon" src="{{asset('website/assets/images/icon/contact-phone.svg')}}" alt="images">
                                                </fieldset>
                                            </div>
                                            <div class="wd-find-select">
                                                <label class="font-2 fw-8 fs-16">نوع العقار</label>
                                                <div class="nice-select relative" tabindex="0"><span class="current d-block">اختار</span>
                                                    <ul class="list style">                                                          
                                                      <li data-value class="option selected">اختار</li>
                                                      <li data-value="apartment" class="option">شقة</li>
                                                      <li data-value="house" class="option">منزل</li>                                                                  
                                                      <li data-value="rent" class="option">إيجار</li>
                                                    </ul>
                                                    <img class="img-icon icon-style" src="{{asset('website/assets/images/icon/contact-choose.svg')}}" alt="images">
                                                </div>
                                            </div>
                                            <fieldset class="message-wrap">
                                                <label class="font-2 fw-8 fs-16">الرسالة</label>
                ...
                <div class="container">
                    <div class="row">                      
                        <div class="col-lg-12">
                            <div class="heading-section center">
                                <h2>من مدونتنا</h2>
                                <p class="text-color-4">استكشف أحدث العقارات من مدونتنا لتبقى على اطلاع بكل ما هو جديد ومفيد</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images img-style relative ">
                                    <a href="#"><img src="{{asset('website/assets/images/img-box/blog-1.jpg')}}" alt="images"></a>
                                    <div class="sub-box flex align-center fs-13 fw-6">
                                        <div class="title-1">ابريل</div><a class="title-2 text-color-3" href="#">الإسكان</a>
                                    </div>
                                </div>
                                <div class="content center">
                                    <h3 class="link-style-1"><a href="#">بناء المكاسب في أسهم الإسكان وكيفية تداول هذا القطاع</a></h3>
                                    <div class="meta">
                                        <a href="#" class="btn-button flex align-center justify-center fs-13 fw-6 text-color-3"><span>اقرأ المزيد</span> 
                                            <svg')}} width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
                                                <path d="M0.875 6H12.125M12.125 6L7.0625 0.9375M12.125 6L7.0625 11.0625" stroke="#2C8FDB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg')}}> 
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images img-style relative ">
                                    <a href="#"><img src="{{asset('website/assets/images/img-box/blog-2.jpg')}}" alt="images"></a>
                                    <div class="sub-box flex align-center fs-13 fw-6">
                                        <div class="title-1">ابريل</div><a class="title-2 text-color-3" href="#">الإسكان</a>
                                    </div>
                                </div>
                                <div class="content center">
                                    <h3 class="link-style-1"><a href="#">92% من مشتري المنازل من جيل الألفية يقولون إن التضخم أثر على خططهم</a></h3>
                                    <div class="meta">
                                        <a href="#" class="btn-button flex align-center justify-center fs-13 fw-6 text-color-3"><span>اقرأ المزيد</span> 
                                            <svg')}} width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
                                                <path d="M0.875 6H12.125M12.125 6L7.0625 0.9375M12.125 6L7.0625 11.0625" stroke="#2C8FDB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="box hover-img">
                                <div class="images img-style relative ">
                                    <a href="#"><img src="{{asset('website/assets/images/img-box/blog-3.jpg')}}" alt="images"></a>
                                    <div class="sub-box flex align-center fs-13 fw-6">
                                        <div class="title-1">ابريل</div><a class="title-2 text-color-3" href="#">الإسكان</a>
                                    </div>
                                </div>
                                <div class="content center">
                                    <h3 class="link-style-1"><a href="#">الرئيس التنفيذي للعقارات: نقوم بالتوظيف "بشكل معتدل"</a></h3>
                                    <div class="meta">
                                        <a href="#" class="btn-button flex align-center justify-center fs-13 fw-6 text-color-3"><span>اقرأ المزيد</span> 
                                            <svg')}} width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg')}}">
                                                <path d="M0.875 6H12.125M12.125 6L7.0625 0.9375M12.125 6L7.0625 11.0625" stroke="#2C8FDB" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="row">                      
                        <div class="col-lg-12">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box center">
                                            ...
                                            <div class="author-box">
                                                <div class="images">
                                                    <img src="{{asset('website/assets/images/author/author-testimonial.jpg')}}" alt="images">
                                                </div>
                                                <h4>Esther Howard</h4>
                            ...
                            <div class="box-title flex justify-center">
                                <div class="inner-title flex justify-center align-center"><h4 class="title-1 fw-4">كن عميلنا التالي، واعثر على منزل أحلامك </h4> <a href="tel:0123456789" ><h4 class="text-color-3">اتصل بنا: 314-555-0123</h4> </a></div> 
                            </div>
                        </div>
                    </div>
                </div>
