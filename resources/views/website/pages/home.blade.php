...
@section('content')
    ...
    @include('website.pages.home_section.feature')
    @include('website.pages.home_section.locations')
    @include('website.pages.home_section.rent')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading-section center">
                        ...
                        <p class="text-color-4">تعرف على وكلائنا المحترفين، الذين سيساعدونك في العثور على أفضل الخيارات
                            لاحتياجاتك العقارية.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="box hover-img">
                        <div class="images relative img-style">
                            <a href="#"><img src="{{ asset('website/assets/images/img-box/meet-1.jpg') }}"
                                    alt="images"></a>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="box hover-img">
                        <div class="images relative img-style">
                            <a href="#"><img src="{{ asset('website/assets/images/img-box/meet-2.jpg') }}"
                                    alt="images"></a>
                            <div class="icon-socials">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="box hover-img">
                        <div class="images relative img-style">
                            <a href="#"><img src="{{ asset('website/assets/images/img-box/meet-3.jpg') }}"
                                    alt="images"></a>
                            <div class="icon-socials">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-12">
                    <div class="box-text flex justify-center">
                        <p>كن وكيلًا واحصل على العمولة التي تستحقها. </p> <a href="contact.html"
                            class="text-color-3 font-2 fw-7"> اتصل بنا</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="heading-section">
                        <h2 class="font-2 fw-8">@lang('website.We offer you the latest contracts and quality.')</h2>
                        <p class="text-color-4">نحن نقدم لك العقارات التي تجمع بين الجودة العالية والملاءمة المثلى لتلبية
                            احتياجاتك.</p>
                    </div>
                    <div class="wrap-info">
                        <div class="box-info flex align-center">
                            ...
                            <div class="content">
                                ...
                                <h4 class="fw-4">{{$settings['address']}}</h4>
                            </div>
                        </div>
                        <div class="box-info flex align-center">
                            <div class="icon-info">
                            ...
                            <div class="content">
                                ...
                                <a href="tel:{{$settings['phone']}}">
                                    <h4 class="fw-8 font-2 fs-30 text-color-3 lh-37">{{$settings['phone']}}</h4>
                                </a>
                            </div>
                        </div>
                        <div class="box-info flex align-center">
                            ...
                            <div class="content">
                                ...
                                <a href="mailto:{{$settings['email']}}">
                                    <h4 class="fw-4 text-color-3">{{$settings['email']}}</h4>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="mark-contact animate-up">
                        <img class="img-icon"
                            src="{{ asset('website/assets/images/mark/transformed.png') }} alt="images">
                    </div>
                </div>
                <div class="col-lg-6">
                            ...
                            <div class="respond-comment">
                                <form method="post" id="contactform" class="comment-form form-submit"
                                    ...
                                    <fieldset class="name-wrap">
                                        ...
                                        <input type="text" class="tb-my-input" name="name" placeholder="الاسم"
                                            required="">
                                        <img class="img-icon"
                                            src="{{ asset('website/assets/images/icon/contact-name.svg') }}"
                                            alt="images">
                                    </fieldset>
                                    <div class="text-wrap flex">
                                        <fieldset class="email-wrap style-text">
                                            ...
                                            <img class="img-icon img-email"
                                                src="{{ asset('website/assets/images/icon/contact-email.svg') }}"
                                                alt="images">
                                        </fieldset>
                                        <fieldset class="phone-wrap style-text">
                                            ...
                                            <img class="img-icon"
                                                src="{{ asset('website/assets/images/icon/contact-phone.svg') }}"
                                                alt="images">
                                        </fieldset>
                                    </div>
                                    <div class="wd-find-select">
                                        ...
                                        <div class="nice-select relative" tabindex="0"><span
                                                class="current d-block">اختار</span>
                                            <ul class="list style">
                                            ...
                                            <img class="img-icon icon-style"
                                                src="{{ asset('website/assets/images/icon/contact-choose.svg') }}"
                                                alt="images">
                                        </div>
                                    </div>
                                    <fieldset class="message-wrap">
                                        <label class="font-2 fw-8 fs-16">الرسالة</label>
                                        <textarea id="comment-message" name="message" rows="4" tabindex="4" placeholder="اكتب رسالتك"></textarea>
                                    </fieldset>
    ...
    <section class="flat-blog tf-section home">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading-section center">
                        <h2>@lang('website.from_our_blog')</h2>
                        <p class="text-color-4">@lang('website.explore_latest_blog')</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="box hover-img">
                        <div class="images img-style relative">
                            ...
                            <div class="sub-box flex align-center fs-13 fw-6">
                                <div class="title-1">@lang('website.blog_1_month')</div>
                                <a class="title-2 text-color-3" href="#">@lang('website.blog_1_category')</a>
                            </div>
                        </div>
                        <div class="content center">
                            <h3 class="link-style-1">
                                <a href="#">@lang('website.blog_1_title')</a>
                            </h3>
                            <div class="meta">
                                <a href="#" class="btn-button flex align-center justify-center fs-13 fw-6 text-color-3">
                                    <span>@lang('website.read_more')</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="heading-section center">
                        ...
                        <p class="text-color-4">اكتشف تجارب عملائنا السعداء وآرائهم حول خدماتنا وكيفية تحقيق رضاهم الكامل
                        </p>
                    </div>
                                ...
                                <div class="box center">
                                    <div class="inner">
                                        ...
                                        <div class="texts font-2 fs-16 fw-5 lh-24">
                                            “ شركة العقارات هذه رائعة! كانت تجربة شراء المنزل سلسة بفضل احترافيتهم ودعمهم
                                            المستمر ”
                                        </div>
                                    </div>
                                    <div class="author-box">
                                        <div class="images">
                                            <img src="{{ asset('website/assets/images/author/author-testimonial.jpg') }}"
                                                alt="images">
                                        </div>
                                        <h4>Esther Howard</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="box center">
                                    <div class="inner">
                                        ...
                                        <div class="texts font-2 fs-16 fw-5 lh-24">
                                            “ الخدمة ممتازة، وفريق العمل كان دائمًا متعاونًا في كل خطوة. وجدنا العقار
                                            المثالي بسرعة بفضلهم ”
                                        </div>
                                    </div>
                                    <div class="author-box">
                                        <div class="images">
                            ...
                            <div class="swiper-slide">
                                <div class="box center">
                                    <div class="inner">
                                        ...
                                        <div class="texts font-2 fs-16 fw-5 lh-24">
                                            “ انا سعيد جدًا باختياري لهذه الشركة. التعامل كان احترافيًا، والموظفون كانوا
                                            متجاوبين للغاية مع احتياجاتنا ”
                                        </div>
                                    </div>
                                    <div class="author-box">
                                        <div class="images">
                    ...
                    <div class="box-title flex justify-center">
                        <div class="inner-title flex justify-center align-center">
                            <h4 class="title-1 fw-4">كن عميلنا التالي، واعثر على منزل أحلامك </h4> <a
                                href="tel:0123456789">
                                <h4 class="text-color-3">اتصل بنا: 314-555-0123</h4>
                            </a>
                        </div>
                    </div>
                </div>
