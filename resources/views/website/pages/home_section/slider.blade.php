   ...
   <section class="slider home">
    <div class="slider-item">
        <div class="img-slider">
            <img class="img-item" src="{{ asset('website/assets/images/slider/bg-slider-1.png') }} " alt="">
        </div>
            ...
            <div class="row"> 
                <div class="col-lg-12">
                    <div class="content po-content-two">
                        <div class="heading">
                            <h1 class="wow slideInDown"  data-wow-delay="0ms" data-wow-duration="1200ms">سوف نجد لك المنزل المثالي</h1>
                            <p class="fs-18 lh-24 text-color-2 wow fadeInUp"  data-wow-delay="100ms" data-wow-duration="2000ms">ابحث عن مجموعة متنوعة من العقارات التي تناسبك بسهولة تامة، وانسى كل الصعوبات في العثور على سكن يناسبك</p>
                        </div>
                        <div class="flat-tabs themesflat-tabs">
                            <div class="box-tab center">
                                <ul class="menu-tab tab-title flex">
                                    <li class="item-title active">
                                        <h4 class="inner">ايجار</h4>
                                    </li>
                                    <li class="item-title style">
                                        <h4 class="inner">شراء</h4>
                                    </li>
                                </ul>
                            </div>
                                            ...
                                            <div class="wd-find-select flex">
                                                <div class="inner-group">
                                                    <div class="form-group-1 search-form form-style">
                                                        <input type="search" class="search-field" placeholder="نوع الكلمة الرئيسية..." value="" name="s" title="Search for" required="">
                                                    </div>
                                            ...
                                            <div class="wd-find-select wd-search-form ">
                                                <div class="box1 flex flex-wrap form-wg">
                                                    <div class="form-group wg-box3">
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span class="current">حمام:أى عدد</span>
                                                                <ul class="list"> 
                                                                    <li data-value class="option selected">حمام:أى عدد</li>                                                         
                                                    ...
                                                    <div class="form-group wg-box3">
                                                        <div class="group-select">
                                                            <div class="nice-select" tabindex="0"><span class="current">سرير:أى عدد</span>
                                                                <ul class="list">   
                                                                    <li data-value class="option selected">سرير:أى عدد</li>                                                       
                                                                    <li data-value="1" class="option">1</li>
                                                                    <li data-value="2" class="option">2</li>
                                                                    <li data-value="3" class="option">3</li>
                                                                    <li data-value="4" class="option">4</li>
                                                ...
                                                <div class="box2 flex flex-wrap form-wg">
                                                    <div class="form-group wg-box3">
                                                        <div class="tf-amenities bg-white">
                                                            <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                                                <span class="btn-checkbox"></span><span class="fs-13">حمام السباحة</span> 
                                                            </label>
                                                            <label class="flex"><input name="newsletter" type="checkbox" /> 
                                                                <span class="btn-checkbox"></span><span class="fs-13">جراش</span> 
                                                            </label>
                                                            <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                                                <span class="btn-checkbox"></span><span class="fs-13">نظام الانذار</span> 
                                                            </label> 
                                                        </div>                                                  
                                                    </div> 
                                                    <div class="form-group wg-box3">
                                                        <div class="tf-amenities bg-white">
                                                            ...
                                                            <label class="flex"><input name="newsletter" type="checkbox" /> 
                                                                <span class="btn-checkbox"></span><span class="fs-13">شبكة الإنترنت عريضة النطاق</span> 
                                                            </label>                                   
                                                        </div>                                                  
                                                    </div> 
                                                    <div class="form-group wg-box3">
                                                        <div class="tf-amenities bg-white">
                                                            ...
                                                            <label class="flex"><input name="newsletter" type="checkbox" /> 
                                                                <span class="btn-checkbox"></span><span class="fs-13">خزائن مدمجة في الجدران</span> 
                                                            </label>
                                                            <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                                    ...
                                                    <div class="form-group wg-box3">
                                                        <div class="tf-amenities bg-white">
                                                            ...
                                                            <label class="flex"><input name="newsletter" type="checkbox"  /> 
                                                                <span class="btn-checkbox"></span><span class="fs-13">المذاكرة</span> 
                                                            </label>
                                                            <label class="flex"><input name="newsletter" type="checkbox"  /> 
                        ...
                        <div class="themes-count tf-counter flex">
                            <div class="counter-box one ">
                                ...
                                <div class="title-count fw-6 fs-13 text-color-4">عقار جاهز</div>                              
                            </div>
                            <div class="counter-box ">
                                <div class="count-number "> 
                                    <div class="number number-style number-one" data-speed="2000" data-to="700" data-inviewport="yes"></div>                                                      
                                </div>
                                <div class="title-count fw-6 fs-13 text-color-4">عميل سعيد</div>                                                                           
                            </div>
                        </div>                      
                    </div> 
                    <div class="images po-content-one">
                        <div class="image">
                             <img class="img-item" src="{{ $banner ? asset($banner->image) : asset('website/assets/images/slider/slider-1.png') }}" alt="">

                        </div>
                    </div> 
                    <div class="curved-group home d-none">
                        <div class="curved-text">العقارات تجد أحلامك الحقيقية</div>
                    </div>                                      
                </div>
            </div>
        </div> 
