        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 col-12">
                <div class="group-icon">
                    <div class="box-icons flex">
                        ...
                        <div class="content">
                            <div class="title-icon fs-30 lh-45 fw-7 text-color-2">انت بحاجة الى منزل</div>
                            <p class="font-2 text-color-2">أخبرنا باحتياجاتك، وسنقدم لك آلاف الاقتراحات لمنزل أحلامك.</p>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="group-icon group-2">
                    <div class="box-icons flex">
                        ...
                        <div class="content">
                            <div class="title-icon fs-30 lh-45 fw-7 text-color-2">تريد بيع المنزل </div>
                            <p class="font-2 text-color-2">سنقوم بربطك بآلاف الأشخاص الذين يحتاجون إلى شراء منزل.</p>
                        </div>
                    </div>
                    <div class="button-footer center">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="widget widget-info">
                    ...
                    <h5 class="text-color-1">{{$settings['address']}}</h5>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="widget widget-menu style-3 ">
                    <h3>شركتنا</h3>   
                    <ul class="box-menu">
                        <li><a href="all-properties.html">عقارات للبيع</a></li>
                        <li><a href="about.html">معلومات عنا</a></li>
                        <li><a href="#">وكلاؤنا</a></li>
                ...
                <div class="widget widget-menu widget-form">
                    ...
                    <form method="post" class="comment-form form-submit" action="#" accept-charset="utf-8">
                        ...
                        <label class="flex">
                            ...
                            <span class="fs-12 text-color-8 lh-18">لقد قرأت ووافقت على الشروط والأحكام</span>
                        </label>
                    </form>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="wrap-logo flex align-center justify-space">
                    <div class="logo-footer style box-1" id="logo-footer">
                        <a href="index.html">
                            <img class="one" src="assets/images/logo/logo-footer@2xx.jpg" alt="img" width="197" height="48">
                            <img class="two" src="assets/images/logo/logo-footer@2x.png" alt="img" width="197" height="48">
                        </a>
                    </div>
                    ...
                    <div class="icon-social box-3 text-color-1">
                        ...
                        {{-- <a href="{{$settings['instagram']}}"><i class="fab fa-linkedin-in"></i></a> --}}
