...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US" lang="{{ app()->getLocale() }}" direction="{{app()->getLocale() == "ar" ? "rtl" : "ltr" }}" dir="{{app()->getLocale() == "ar" ? "rtl" : "ltr" }}">
...
<head>
    ...
    <link rel="stylesheet" href="{{asset('website/app/dist/font-awesome.css')}}">

    <link rel="stylesheet" href="{{asset('website/app/dist/app.css')}}">
    <link rel="stylesheet" href="{{asset('website/app/dist/responsive.css')}}">

    @if(app()->getLocale()=='ar')
    <link id="rtl-style" rel="stylesheet" href="{{asset('website/app/dist/app.ar.css')}}" disabled>
    <link id="rtl-style-two" rel="stylesheet" href="{{asset('website/app/dist/responsive.ar.css')}}" disabled>
    @endif


    <link rel="stylesheet" href="{{asset('website/app/dist/owl.css')}}">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="{{asset('website/assets/images/logo/Favicon.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('website/assets/images/logo/Favicon.png')}}">
...
<body class="body  counter-scroll">
    ...
    <!-- Javascript -->
    <script src="{{asset('website/app/js/jquery.min.js')}}"></script>
    <script src="{{asset('website/app/js/jquery.easing.js')}}"></script>
    <script src="{{asset('website/app/js/jquery.nice-select.min.js')}}"></script>
    <script src="{{asset('website/app/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('website/app/js/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('website/app/js/owl.js')}}"></script>
    <script src="{{asset('website/app/js/swiper.js')}}"></script>
    
    <script src="{{asset('website/app/js/jquery-validate.js')}}"></script>
   
    <script src="{{asset('website/app/js/countto.js')}}"></script>
    <script src="{{asset('website/app/js/plugin.js')}}"></script>
    <script src="{{asset('website/app/js/shortcodes.js')}}"></script>
    <script src="{{asset('website/app/js/main.js')}}"></script>
    <script src="{{asset('website/app/js/curved.js')}}"></script>
    <script src="{{asset('website/app/js/price-ranger.js')}}"></script>
