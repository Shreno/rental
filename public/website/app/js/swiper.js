...
$(document).ready(function() {
    ...
    const $rtlStyles = $('#rtl-style, #rtl-style-two, #rtl-style-three');
...
$(document).ready(function() {
    ...
    $('#arabic-btn').on('click', function(event) {
        event.preventDefault();
        $('html').attr('dir', 'rtl');
        ...
        $('#arabic-btn').addClass('active').removeClass('deactive');
        $('#english-btn').addClass('deactive').removeClass('active');
    ...
    $('#english-btn').on('click', function(event) {
        event.preventDefault();
        $('html').removeAttr('dir');
        ...
        $('#arabic-btn').addClass('deactive').removeClass('active');
        $('#english-btn').addClass('active').removeClass('deactive');
