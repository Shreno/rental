...
class SettingSeeder extends Seeder {
    ...
    public function run() {
        DB::table('settings')->insert([
            ...
            ['key' => 'app_name_ar', 'type' => 'text', 'value' => 'أيجار السكن'],
            ...
            ['key' => 'about_ar', 'type' => 'textarea', 'value' => 'أيجار السكن '],
            ['key' => 'about_en', 'type' => 'textarea', 'value' => 'HWZN'],
            ['key' => 'terms_ar', 'type' => 'textarea', 'value' => 'أيجار السكن '],
            ['key' => 'terms_en', 'type' => 'textarea', 'value' => 'HWZN'],
            ['key' => 'policy_ar', 'type' => 'textarea', 'value' => 'أيجار السكن '],
            ...
            ['key' => 'slogan_ar', 'type' => 'text', 'value' => 'أيجار السكن'],
